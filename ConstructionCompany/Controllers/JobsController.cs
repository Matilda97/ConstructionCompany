...
namespace ConstructionCompany.Controllers
{
    public class JobsController : Controller
    {
        ...
        {
            var jobs = db.Jobs.Include(j => j.Material);
        ...
        public ActionResult Create([Bind(Include = "JobID,NameJob,DescriptionJpb,PriceJob,MaterialID")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JobID,NameJob,DescriptionJpb,PriceJob,MaterialID")] Job job)
        {
            if (ModelState.IsValid)
            {
